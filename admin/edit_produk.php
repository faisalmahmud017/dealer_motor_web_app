...
<html>
  ...
  <body>
      ...
      <section class="base">
        ...
        <div>
          <label>Merek</label>
         <input type="text" name="merek" value="<?php echo $data['merek']; ?>" autofocus="" required=""/>
        </div>
        <div>
          <label>Jenis</label>
         <input type="text" name="jenis" value="<?php echo $data['jenis']; ?>" autofocus="" required=""/>
        </div>
        <div>
          <label>Spesifikasi</label>
         <textarea type="text" name="spesifikasi" ><?php echo $data['spesifikasi']; ?></textarea>
         <i style="float: left;font-size: 11px;color: red">*untuk membuat baris baru, gunakan < b r > tanpa spasi. bukan tomobol enter.</i>
        </div>
        <div>
          <label>Stock</label>
