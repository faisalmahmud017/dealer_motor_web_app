        ...
        <div id="header">
            ...
            <div id="sidebar">
                <ul>
                    ...
                    <li class="sidebar-pilih">Katalog</li>
                 ...
                 <table>
                     <thead>
                          ...
                          <tbody>
                            ...
                            ?>
                             <tr>
                             <td style="text-align: center;"><img class="gambar" src="admin/gambar/<?php echo $row['gambar_produk']; ?>" style="width: 150px;"></td>
                                ...
                                <td><a href="lihat.php?id=<?php echo $row['id']; ?>">Lihat</a></td>
                            </tr>
